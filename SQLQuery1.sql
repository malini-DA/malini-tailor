...
CREATE DATABASE SQLAdvanced_Joins_Test;
GO

USE SQLAdvanced_Joins_Test;
GO
...
CREATE TABLE Orders (
    ...
    FOREIGN KEY (customer_id) REFERENCES mCustomer(customer_id),
...
INSERT INTO mCustomer VALUES (1, 'Aarav Mehta', 'Ahmedabad', 'Gujarat', '2025-01-15', 'Enterprise');
INSERT INTO mCustomer VALUES (2, 'Diya Shah', 'Mumbai', 'Maharashtra', '2025-01-20', 'Premium');
INSERT INTO mCustomer VALUES (3, 'Rohan Patel', 'Ahmedabad', 'Gujarat', '2025-02-03', 'Standard');
INSERT INTO mCustomer VALUES (4, 'Ananya Iyer', 'Bengaluru', 'Karnataka', '2025-02-10', 'Premium');
INSERT INTO mCustomer VALUES (5, 'Kabir Joshi', 'Pune', 'Maharashtra', '2025-02-18', 'Standard');
INSERT INTO mCustomer VALUES (6, 'Meera Desai', 'Surat', 'Gujarat', '2025-03-01', 'Premium');
INSERT INTO mCustomer VALUES (7, 'Vivaan Kapoor', 'Delhi', 'Delhi', '2025-03-08', 'Enterprise');
INSERT INTO mCustomer VALUES (8, 'Ishita Rao', 'Hyderabad', 'Telangana', '2025-03-15', 'Standard');
INSERT INTO mCustomer VALUES (9, 'Aditya Singh', 'Jaipur', 'Rajasthan', '2025-03-21', 'Premium');
INSERT INTO mCustomer VALUES (10, 'Sara Khan', 'Lucknow', 'Uttar Pradesh', '2025-04-02', 'Standard');
INSERT INTO mCustomer VALUES (11, 'Arjun Verma', 'Noida', 'Uttar Pradesh', '2025-04-11', 'Enterprise');
INSERT INTO mCustomer VALUES (12, 'Nisha Shah', 'Vadodara', 'Gujarat', '2025-04-18', 'Premium');
INSERT INTO mCustomer VALUES (13, 'Kunal Shah', 'Rajkot', 'Gujarat', '2025-05-03', 'Standard');
INSERT INTO mCustomer VALUES (14, 'Tanya Malhotra', 'Chandigarh', 'Chandigarh', '2025-05-14', 'Premium');
INSERT INTO mCustomer VALUES (15, 'Dev Agarwal', 'Indore', 'Madhya Pradesh', '2025-05-22', 'Standard');
INSERT INTO mCustomer VALUES (16, 'Pooja Nair', 'Kochi', 'Kerala', '2025-06-05', 'Premium');
INSERT INTO mCustomer VALUES (17, 'Manav Gupta', 'Gurugram', 'Haryana', '2025-06-17', 'Enterprise');
INSERT INTO mCustomer VALUES (18, 'Riya Kulkarni', 'Nashik', 'Maharashtra', '2025-06-25', 'Standard');
INSERT INTO mCustomer VALUES (19, 'Yash Trivedi', 'Ahmedabad', 'Gujarat', '2025-07-03', 'Premium');
INSERT INTO mCustomer VALUES (20, 'Sneha Menon', 'Chennai', 'Tamil Nadu', '2025-07-12', 'Standard');
INSERT INTO mCustomer VALUES (21, 'Rahul Bansal', 'Bhopal', 'Madhya Pradesh', '2025-07-21', 'Premium');
INSERT INTO mCustomer VALUES (22, 'Aisha Sheikh', 'Mumbai', 'Maharashtra', '2025-08-02', 'Standard');
INSERT INTO mCustomer VALUES (23, 'Harsh Vora', 'Ahmedabad', 'Gujarat', '2025-08-16', 'Enterprise');
INSERT INTO mCustomer VALUES (24, 'Neha Soni', 'Udaipur', 'Rajasthan', '2025-08-25', 'Standard');
INSERT INTO mCustomer VALUES (25, 'Om Prakash', 'Patna', 'Bihar', '2025-09-04', 'Premium');
INSERT INTO mCustomer VALUES (26, 'Mahi Jain', 'Kolkata', 'West Bengal', '2025-09-13', 'Standard');
INSERT INTO mCustomer VALUES (27, 'Siddharth Roy', 'Bengaluru', 'Karnataka', '2025-09-20', 'Enterprise');
INSERT INTO mCustomer VALUES (28, 'Palak Mehta', 'Surat', 'Gujarat', '2025-10-01', 'Standard');
INSERT INTO mCustomer VALUES (29, 'Atharv Shah', 'Vadodara', 'Gujarat', '2025-10-12', 'Premium');
INSERT INTO mCustomer VALUES (30, 'Kiara Patel', 'Pune', 'Maharashtra', '2025-10-19', 'Standard');
...
GO
--1.Display customer name, city, customer segment, order ID, order date, and order status for every order placed in 2025.
...
--2.Find all customers from Gujarat who belong to the Premium or Enterprise segment. Display customer name, city, and segment.
...
--3.Display all products whose unit price is between ₹5,000 and ₹20,000, sorted from highest price to lowest price.
select product_name,
unit_price
from Products
...
--4.Find all completed orders where the quantity is greater than 4. Display order ID, customer ID, product ID, quantity, and order date.
 select order_id,
 order_status,
 quantity,
 order_date,
 ...
 --5.Display the five most expensive products. Show product name, category, and unit price.
 ...
 --6.Find the total number of customers in each customer segment.
 select customer_segment,
 count (customer_id)
 from mCustomer
 group by customer_segment;

 --7.Calculate the total quantity of products ordered for each product.
 SELECT
    p.product_name,
...
--8.Find the average unit price of products in each category.
...
--9.Find categories whose average product price is greater than ₹10,000.
